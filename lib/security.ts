...
export function sanitizeUrl(url: string | undefined | null): string {
  ...
  if (
    (trimmedUrl.startsWith("/") &&
      !/^\/([\\\/]|\s|\.|%0[0-9a-f]|%1[0-9a-f]|%20|%2[fe]|%5c|%7f|%25|%8[0-9a-f]|%9[0-9a-f]|%a0|\u2044|\u2215|\u2216|\u29F5|\u29F8|\u29F9|\u2024|\u2025|\u2026|\u2027|\u3002|\uFE52|\uFF0E|\uFF61|\uFF0F|\uFF3C|\u06D4|\u166E|\u1803|\u1809|\uA4F8|\uA4FF|\uA60E|\u2E3C|\u2E33|\u0701|\u0702|\u10FB|\u1362|\u00B7|\u02D9|\u0387|\u0589|\u05C9|\u05C8|\uFE68|\uFE12|\u2219|\u22C5|\u2022|\u05B9|\u05BC|\u2E30|\u05BA|\u05BB|\u0660|\u06F0|\u2023|\u2043|\u05B0|\u05B1|\u05B2|\u05B3|\u05B4|\u05B5|\u05B6|\u05C1|\u05C2|\u05C4|\u05C5|\u2052|\u16EB|\u16EC|\u16ED|\u2E37|\u2E38|\u2E39|\u22EE|\u22EF|\u22F0|\u22F1|\u060D|\u05B7|\u05B8|\u05C7|\u066B|\u066C|\u205E|\u205A|\u205B|\u205C|\u205D|\u2056|\u2058|\u2059|\u2E2C|\u2E2D|\u2E3D|\u2E48|\u2E4A|\u2E3E|\u2E41|\u2E54|\u2E55|\u2E56|\u2E57|\u2E58|\u2E59|\u2E5D|\u2AFD|\u2AFE|\u2E2A|\u2E2B|\u2E51|\u2E5A|\u2E5B|\u2E5C|\u061E|\u0700|\u0703|\u1365|\u1366|\u16EE|\u2E44|\u1804|\u1805|\u2E46|\u2E4B|\u2E4C|\u2E4D|\u2E4E|\u2E4F|\u2E52|\u2051|\u2E50|\u2E53|\u0704|\u0705|\u0706|\u0707|\u0708|\u0709|\u2CF9|\u2CFA|\u2D70|\u2E01|\u2E04|\u2E05|\u2E07|\u2E08|\u2E09|\u2E0A|\u2E0C|\u2E0D|\u2E12|\u2E13|\u2E16|\u2E17|\u2E18|\u2E19|\u2E1E|\u2E1F|\u1361|\u2E31|\u{10100}|\u{10101}|\u{10102})/ui.test(
        trimmedUrl,
      )) ||
    trimmedUrl.startsWith("#")
  ) {

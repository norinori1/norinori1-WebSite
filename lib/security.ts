...
export function sanitizeUrl(url: string | undefined | null): string {
  ...
  // invisible mathematical operators) to prevent protocol obfuscation or UI spoofing.
  ...
  // that some browsers might normalize to cross-origin redirects or could lead to path traversal.
  if (

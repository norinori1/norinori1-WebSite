...
export function sanitizeUrl(url: string | undefined | null): string {
  ...
  // - Script-specific word dividers: 𐊐 (U+10290), 𐊑 (U+10291), 𔖱 (U+145B1), 𐏐 (U+103D0), 𐎟 (U+1039F), 𐤟 (U+1091F), 𐊟 (U+1029F), 𐤿 (U+1093F), 𐦾 (U+109BE), 𐦿 (U+109BF), 𐩿 (U+10A7F), 𐫶 (U+10AF6), 𐬹 (U+10B39), 𐬺 (U+10B3A), 𐹾 (U+10E7E), 𐪟 (U+10A9F), 𒑰 (U+12470)

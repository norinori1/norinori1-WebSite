...
export function sanitizeUrl(url: string | undefined | null): string {
  ...
  // Homoglyphs included:
  // - Slashes: / (U+002F), \ (U+005C), ⁄ (U+2044), ∕ (U+2215), ∖ (U+2216), ⧵ (U+29F5), ⧸ (U+29F8), ⧹ (U+29F9), ／ (U+FF0F), ＼ (U+FF3C), ﹨ (U+FE68), ⹊ (U+2E4A), ⫽ (U+2AFD), ⫾ (U+2AFE), ⹋ (U+2E4B), ⹍ (U+2E4D), ⹎ (U+2E4E), ⸗ (U+2E17), ⹐ (U+2E50), ⹓ (U+2E53), ⸒ (U+2E12), ⸓ (U+2E13), ⸖ (U+2E16)
  // - Dots: . (U+002E), ․ (U+2024), ‥ (U+2025), … (U+2026), ‧ (U+2027), 。 (U+3002), ﹒ (U+FE52), ． (U+FF0E), ｡ (U+FF61), ۔ (U+06D4), ᙮ (U+166E), ᠃ (U+1803), ᠉ (U+1809), ꓸ (U+A4F8), ꘎ (U+A60E), ⸼ (U+2E3C), ⸳ (U+2E33), ܂ (U+0701), ܂ (U+0702), ჻ (U+10FB), ። (U+1362), · (U+00B7), ˙ (U+02D9), · (U+0387), ։ (U+0589), ׉ (U+05C9), ׈ (U+05C8), ︒ (U+FE12), ∙ (U+2219), ⋅ (U+22C5), • (U+2022), ֹ (U+05B9), ּ (U+05BC), ⸰ (U+2E30), ֹ (U+05BA), ֻ (U+05BB), ٠ (U+0660), ۰ (U+06F0), ‣ (U+2023), ⁃ (U+2043), ְ (U+05B0), ֱ (U+05B1), ֲ (U+05B2), ֳ (U+05B3), ִ (U+05B4), ֵ (U+05B5), ֶ (U+05B6), ׁ (U+05C1), ׂ (U+05C2), ׄ (U+05C4), ׅ (U+05C5), ⁒ (U+2052), ᛫ (U+16EB), ᛬ (U+16EC), ᛭ (U+16ED), ⸷ (U+2E37), ⸸ (U+2E38), ⸹ (U+2E39), ⋮ (U+22EE), ⋯ (U+22EF), ⋰ (U+22F0), ⋱ (U+22F1), ؍ (U+060D), ַ (U+05B7), ָ (U+05B8), ׇ (U+05C7), ٫ (U+066B), ٬ (U+066C), ⁞ (U+205E), ⁚ (U+205A), ⁛ (U+205B), ⁜ (U+205C), ⁝ (U+205D), ⁖ (U+2056), ⁘ (U+2058), ⁙ (U+2059), ⸬ (U+2E2C), ⸭ (U+2E2D), ⸽ (U+2E3D), ⹈ (U+2E48), ⸾ (U+2E3E), ⹁ (U+2E41), ⹔ (U+2E54), ⹕ (U+2E55), ⹖ (U+2E56), ⹗ (U+2E57), ⹘ (U+2E58), ⹙ (U+2E59), ⹝ (U+2E5D), ⸪ (U+2E2A), ⸫ (U+2E2B), ⹑ (U+2E51), ⹚ (U+2E5A), ⹛ (U+2E5B), ⹜ (U+2E5C), ؞ (U+061E), ܀ (U+0700), ܃ (U+0703), ፥ (U+1365), ፦ (U+1366), ᛮ (U+16EE), ⹄ (U+2E44), ᠄ (U+1804), ᠅ (U+1805), ⹆ (U+2E46), ⹌ (U+2E4C), ⹏ (U+2E4F), ⹒ (U+2E52), ⁑ (U+2051), ⹐ (U+2E50), ⹓ (U+2E53), ܄ (U+0704), ܅ (U+0705), ܆ (U+0706), ܇ (U+0707), ܈ (U+0708), ܉ (U+0709), ⳹ (U+2CF9), ⳺ (U+2CFA), ⵰ (U+2D70), ꓿ (U+A4FF), ⸁ (U+2E01), ⸄ (U+2E04), ⸅ (U+2E05), ⸇ (U+2E07), ⸈ (U+2E08), ⸉ (U+2E09), ⸊ (U+2E0A), ⸌ (U+2E0C), ⸍ (U+2E0D), ⸞ (U+2E1E), ⸟ (U+2E1F), ⸘ (U+2E18), ⸙ (U+2E19)
  // - Visible Punctuation and Word Separators: Ethiopic Wordspace (U+1361), Word Separator Middle Dot (U+2E31), Ring Point (U+2E30), Aegean Word Separators (U+10100, U+10101, U+10102), Infix Wedge (U+2E0B), Hyphen with Diaeresis (U+2E1A), Siglum (U+2E1B), Turned Comma (U+2E32), Raised Comma (U+2E34), Turned Semicolon (U+2E35), Double Stacked Comma (U+2E49), Reversed Semicolon (U+204F), Left Low Paraphrase Bracket (U+2E1C), Right Low Paraphrase Bracket (U+2E1D), Syriac Abbreviation Mark (U+070F), Double Hyphen (U+2E40)
  ...
  if (
    (trimmedUrl.startsWith("/") &&
      !/^\/([\\\/]|\s|\.|%0[0-9a-f]|%1[0-9a-f]|%20|%2[fe]|%5c|%7f|%25|%8[0-9a-f]|%9[0-9a-f]|%a0|\u2044|\u2215|\u2216|\u29F5|\u29F8|\u29F9|\u2024|\u2025|\u2026|\u2027|\u3002|\uFE52|\uFF0E|\uFF61|\uFF0F|\uFF3C|\u06D4|\u166E|\u1803|\u1809|\uA4F8|\uA4FF|\uA60E|\u2E3C|\u2E33|\u0701|\u0702|\u10FB|\u1362|\u00B7|\u02D9|\u0387|\u0589|\u05C9|\u05C8|\uFE68|\uFE12|\u2219|\u22C5|\u2022|\u05B9|\u05BC|\u2E30|\u05BA|\u05BB|\u0660|\u06F0|\u2023|\u2043|\u05B0|\u05B1|\u05B2|\u05B3|\u05B4|\u05B5|\u05B6|\u05C1|\u05C2|\u05C4|\u05C5|\u2052|\u16EB|\u16EC|\u16ED|\u2E37|\u2E38|\u2E39|\u22EE|\u22EF|\u22F0|\u22F1|\u060D|\u05B7|\u05B8|\u05C7|\u066B|\u066C|\u205E|\u205A|\u205B|\u205C|\u205D|\u2056|\u2058|\u2059|\u2E2C|\u2E2D|\u2E3D|\u2E48|\u2E4A|\u2E3E|\u2E41|\u2E54|\u2E55|\u2E56|\u2E57|\u2E58|\u2E59|\u2E5D|\u2AFD|\u2AFE|\u2E2A|\u2E2B|\u2E51|\u2E5A|\u2E5B|\u2E5C|\u061E|\u0700|\u0703|\u1365|\u1366|\u16EE|\u2E44|\u1804|\u1805|\u2E46|\u2E4B|\u2E4C|\u2E4D|\u2E4E|\u2E4F|\u2E52|\u2051|\u2E50|\u2E53|\u0704|\u0705|\u0706|\u0707|\u0708|\u0709|\u2CF9|\u2CFA|\u2D70|\u2E01|\u2E04|\u2E05|\u2E07|\u2E08|\u2E09|\u2E0A|\u2E0C|\u2E0D|\u2E12|\u2E13|\u2E16|\u2E17|\u2E18|\u2E19|\u2E1E|\u2E1F|\u1361|\u2E31|\u{10100}|\u{10101}|\u{10102}|\u2E0B|\u2E1A|\u2E1B|\u2E32|\u2E34|\u2E35|\u2E49|\u204F|\u2E1C|\u2E1D|\u070F|\u2E40)/iu.test(
        trimmedUrl,
      )) ||
    trimmedUrl.startsWith("#")
  ) {

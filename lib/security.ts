...
export function sanitizeUrl(url: string | undefined | null): string {
  ...
  // - Infix Wedge (U+2E0B), Hyphen with Diaeresis (U+2E1A), Siglum (U+2E1B)
  ...
  // Homoglyphs included:
  // - Slashes: / (U+002F), \ (U+005C), ⁄ (U+2044), ∕ (U+2215), ∖ (U+2216), ⧵ (U+29F5), ⧸ (U+29F8), ⧹ (U+29F9), ／ (U+FF0F), ＼ (U+FF3C), ﹨ (U+FE68), ⁒ (U+2052)

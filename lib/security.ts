...
export function sanitizeUrl(url: string | undefined | null): string {
  ...
  // and dangerous Unicode characters (BiDi, zero-width, separators, and
  // obfuscation characters like Mongolian Vowel Separator or soft hyphens)
  // to prevent protocol obfuscation or UI spoofing.
  const trimmedUrl = normalizedUrl.replace(
    /[\x00-\x1F\x7F-\x9F\s\u00AD\u034F\u115F\u1160\u180E\u200B-\u200D\u200E\u200F\u2028\u2029\u202A-\u202E\u2060\u2066-\u2069\u3164\uFFA0\uFEFF]/gu,
    "",
  );

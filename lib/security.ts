...
export function sanitizeUrl(url: string | undefined | null): string {
  ...
  // - Script-specific word dividers: 𐊐 (U+10290), 𐊑 (U+10291), 𐊟 (U+1029F), 𐎟 (U+1039F), 𐏐 (U+103D0), 𐤟 (U+1091F), 𐤿 (U+1093F), 𐦾 (U+109BE), 𐦿 (U+109BF), 𐩟 (U+10A9F), 𐩿 (U+10A7F), 𐫶 (U+10AF6),  (U+10B39),  (U+10B3A), 𐹾 (U+10E7E), 𒑰 (U+12470), 𔖱 (U+145B1)
  ...
  if (
    (trimmedUrl.startsWith("/") &&
      !/^\/([\\\/]|\s|\.|%0[0-9a-f]|%1[0-9a-f]|%20|%2[fe]|%5c|%7f|%25|%8[0-9a-f]|%9[0-9a-f]|%a0|\u2044|\u2215|\u2216|\u29F5|\u29F8|\u29F9|\u2024|\u2025|\u2026|\u2027|\u3002|\uFE52|\uFF0E|\uFF61|\uFF0F|\uFF3C|\u06D4|\u166E|\u1803|\u1809|\uA4F8|\uA4FF|\uA60E|\u2E3C|\u2E33|\u0701|\u0702|\u10FB|\u1362|\u00B7|\u02D9|\u0387|\u0589|\u05C9|\u05C8|\uFE68|\uFE12|\u2219|\u22C5|\u2022|\u05B9|\u05BC|\u2E30|\u05BA|\u05BB|\u0660|\u06F0|\u2023|\u2043|\u05B0|\u05B1|\u05B2|\u05B3|\u05B4|\u05B5|\u05B6|\u05C1|\u05C2|\u05C4|\u05C5|\u2052|\u16EB|\u16EC|\u16ED|\u2E37|\u2E38|\u2E39|\u22EE|\u22EF|\u22F0|\u22F1|\u060D|\u05B7|\u05B8|\u05C7|\u066B|\u066C|\u205E|\u205A|\u205B|\u205C|\u205D|\u2056|\u2058|\u2059|\u2E2C|\u2E2D|\u2E3D|\u2E48|\u2E4A|\u2E3E|\u2E41|\u2E54|\u2E55|\u2E56|\u2E57|\u2E58|\u2E59|\u2E5D|\u2AFD|\u2AFE|\u2E2A|\u2E2B|\u2E51|\u2E5A|\u2E5B|\u2E5C|\u061E|\u0700|\u0703|\u1365|\u1366|\u16EE|\u2E44|\u1804|\u1805|\u2E46|\u2E4B|\u2E4C|\u2E4D|\u2E4E|\u2E4F|\u2E52|\u2051|\u2E50|\u2E53|\u0704|\u0705|\u0706|\u0707|\u0708|\u0709|\u2CF9|\u2CFA|\u2D70|\u2E01|\u2E04|\u2E05|\u2E07|\u2E08|\u2E09|\u2E0A|\u2E0C|\u2E0D|\u2E12|\u2E13|\u2E16|\u2E17|\u2E18|\u2E19|\u2E1E|\u2E1F|\u1361|\u2E31|\u{10100}|\u{10101}|\u{10102}|\u{10290}|\u{10291}|\u{1029F}|\u{1039F}|\u{103D0}|\u{1091F}|\u{1093F}|\u{109BE}|\u{109BF}|\u{10A9F}|\u{10A7F}|\u{10AF6}|\u{10B39}|\u{10B3A}|\u{10E7E}|\u{12470}|\u{145B1}|\u2E0B|\u2E1A|\u2E1B|\u2E32|\u2E34|\u2E35|\u2E49|\u204F|\u2E1C|\u2E1D|\u070F|\u2E40|\u2E2E|\u2E23|\u2E24|\u2E25|\u2E26|\u2E27|\u2E28|\u2E29|\u2E45|\u2E47|\u2E20|\u2E21|\u2E22|\u2E36|\u2E3A|\u2E3B|\u2E3F|\u2E42|\u2E43|\u2CFB|\u2CFC|\u2CFD|\u2CFE|\u2CFF|\u1363|\u1364|\u1367|\u1368|\u05C0|\u05C3|\u05C6|\u066D|\u070A|\u070B|\u070C|\u070D|\u070E)/ui.test(
        trimmedUrl,
      )) ||
    trimmedUrl.startsWith("#")
  ) {

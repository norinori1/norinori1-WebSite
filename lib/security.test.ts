...
const testCases = {
  ...
  sanitizeUrl: [
    ...
    },
    {
      url: "/\uFE12\uFE12/etc/passwd",
      expected: "about:blank",
      description: "Vertical ideographic full stop bypass in relative path",
    },
    {
      url: "/\u2219\u2219/etc/passwd",
      expected: "about:blank",
    ...
    },
    {
      url: "/\u05B9\u05B9/etc/passwd",
      expected: "about:blank",
      description: "Hebrew point holam bypass in relative path",
    },
    {
      url: "/\u05BC\u05BC/etc/passwd",
      expected: "about:blank",
      description: "Hebrew point dagesh or mapiq bypass in relative path",
    },
    {
      url: "/\uFE68\uFE68attacker.com",
      expected: "about:blank",

...
const testCases = {
  ...
  sanitizeUrl: [
    ...
    },
    {
      url: "/\u070C\u070C/etc/passwd",
      expected: "about:blank",
      description: "Syriac colon bypass in relative path (alt)",
    },
    {
      url: "/\u070D\u070D/etc/passwd",
      expected: "about:blank",
    ...
    },
    {
      url: "/\u070E\u070E/etc/passwd",
      expected: "about:blank",
      description: "Syriac music mark alt (U+070E) bypass in relative path",
    },
    {
      url: "/\u1363\u1363/etc/passwd",
      expected: "about:blank",
    ...
    },
    {
      url: "/\u1364\u1364/etc/passwd",
      expected: "about:blank",
      description: "Ethiopic semicolon bypass in relative path (alt)",
    },
    {
      url: "/\u1367\u1367/etc/passwd",
      expected: "about:blank",
    ...
    },
    {
      url: "/\u2CFC\u2CFC/etc/passwd",
      expected: "about:blank",
      description: "Coptic fraction one fourth bypass in relative path",
    },
    {
      url: "/\u2CFD\u2CFD/etc/passwd",
      expected: "about:blank",
      description: "Coptic fraction three fourths bypass in relative path",
    },
    {
      url: "/\u2CFE\u2CFE/etc/passwd",
      expected: "about:blank",
      description: "Coptic fraction one eighth bypass in relative path",
    },
    {
      url: "/\u2CFF\u2CFF/etc/passwd",
      expected: "about:blank",
      description: "Coptic fractional mark bypass in relative path",
    },
    {
      url: null as unknown as string,
      expected: "",

...
const testCases = {
  ...
  sanitizeUrl: [
    ...
    },
    {
      ...
      description: "Visible Ethiopic wordspace in absolute URL (not stripped, encoded)",
    },
    {
      url: "https://example.com/aegean\u{10101}separator",
      expected: "https://example.com/aegean%F0%90%84%81separator",
      description: "Visible Aegean word separator dot in absolute URL (not stripped, encoded)",
    },
    {
      url: "https://example.com/middle\u2E31dot",
      expected: "https://example.com/middle%E2%B8%B1dot",
      description: "Visible word separator middle dot in absolute URL (not stripped, encoded)",
    },
    {
      url: "https://example.com/ring\u2E30point",
      expected: "https://example.com/ring%E2%B8%B0point",
      description: "Visible ring point in absolute URL (not stripped, encoded)",
    },
    {
      url: "https://example.com/aegean\u{10100}line",
      expected: "https://example.com/aegean%F0%90%84%80line",
      description: "Visible Aegean word separator line in absolute URL (not stripped, encoded)",
    },
    {
      url: "https://example.com/aegean\u{10102}check",
      expected: "https://example.com/aegean%F0%90%84%82check",
      description: "Visible Aegean check mark in absolute URL (not stripped, encoded)",
    },
    {
      url: "/\u1362\u1362/etc/passwd",
      expected: "about:blank",
    ...
    },
    {
      url: "java\u2E0Bscript:alert(1)",
      expected: "about:blank",
      description: "Visible Infix wedge in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E1Ascript:alert(1)",
      expected: "about:blank",
      description: "Visible Hyphen with diaeresis in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E1Bscript:alert(1)",
      expected: "about:blank",
      description: "Visible Siglum in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E32script:alert(1)",
      expected: "about:blank",
      description: "Visible Turned comma in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E34script:alert(1)",
      expected: "about:blank",
      description: "Visible Raised comma in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E35script:alert(1)",
      expected: "about:blank",
      description: "Visible Turned semicolon in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E49script:alert(1)",
      expected: "about:blank",
      description: "Visible Double stacked comma in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u204Fscript:alert(1)",
      expected: "about:blank",
      description: "Visible Reversed semicolon in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E1Dscript:alert(1)",
      expected: "about:blank",
      description: "Visible Right low paraphrase bracket in protocol (not stripped, causes failure)",
    },
    {
      url: "https\u2E1C://example.com",
      expected: "about:blank",
      description: "Visible Left low paraphrase bracket in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u070Fscript:alert(1)",
      expected: "about:blank",
      description: "Visible Syriac abbreviation mark in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E40script:alert(1)",
      expected: "about:blank",
      description: "Visible Double hyphen in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E01script:alert(1)",
      expected: "about:blank",
      description: "Visible Right angle dotted substitution marker in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E04script:alert(1)",
      expected: "about:blank",
      description: "Visible Left dotted substitution bracket in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E05script:alert(1)",
      expected: "about:blank",
      description: "Visible Right dotted substitution bracket in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E07script:alert(1)",
      expected: "about:blank",
      description: "Visible Raised dotted interpolation marker in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E08script:alert(1)",
      expected: "about:blank",
      description: "Visible Dotted transposition marker in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E13script:alert(1)",
      expected: "about:blank",
      description: "Visible Dotted obelos in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E16script:alert(1)",
      expected: "about:blank",
      description: "Visible Dotted right-pointing angle in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E1Escript:alert(1)",
      expected: "about:blank",
      description: "Visible Tilde with dot above in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E1Fscript:alert(1)",
      expected: "about:blank",
      description: "Visible Tilde with dot below in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E17script:alert(1)",
      expected: "about:blank",
      description: "Visible Oblique slant in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E09script:alert(1)",
      expected: "about:blank",
      description: "Visible Left transcription bracket in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E0Ascript:alert(1)",
      expected: "about:blank",
      description: "Visible Right transcription bracket in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E0Cscript:alert(1)",
      expected: "about:blank",
      description: "Visible Raised wedge in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E0Dscript:alert(1)",
      expected: "about:blank",
      description: "Visible Low wedge in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E12script:alert(1)",
      expected: "about:blank",
      description: "Visible Dotted reversed comma in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E18script:alert(1)",
      expected: "about:blank",
      description: "Visible Inverted interrogation mark in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2E19script:alert(1)",
      expected: "about:blank",
      description: "Visible Palm branch in protocol (not stripped, causes failure)",
    },
    {
      url: "java\u2061script:alert(1)",
      expected: "about:blank",
      description: "Invisible mathematical operator in protocol (stripped)",
    },
    {
      url: "/%80/attacker.com",
      expected: "about:blank",
    ...
    },
    {
      url: "java\u1361script:alert(1)",
      expected: "about:blank",
      description: "Visible Ethiopic wordspace in protocol (not stripped)",
    },
    {
      url: "java\u2E31script:alert(1)",
      expected: "about:blank",
      description: "Visible middle dot in protocol (not stripped)",
    },
    {
      url: "/\u2CFB\u2CFBattacker.com",
      expected: "about:blank",

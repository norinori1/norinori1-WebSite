...
const testCases = {
  ...
  sanitizeUrl: [
    ...
    },
    {
      url: "java\u2E32script:alert(1)",
      expected: "about:blank",
      description: "Turned comma in protocol (now blocks instead of stripping)",
    },
    {
      url: "java\u2E34script:alert(1)",
      expected: "about:blank",
      description: "Raised comma in protocol (now blocks instead of stripping)",
    },
    {
      url: "java\u2E35script:alert(1)",
      expected: "about:blank",
      description: "Turned semicolon in protocol (now blocks instead of stripping)",
    },
    {
      url: "java\u2E49script:alert(1)",
      expected: "about:blank",
      description: "Double stacked comma in protocol (now blocks instead of stripping)",
    },
    {
      url: "java\u204Fscript:alert(1)",
      expected: "about:blank",
      description: "Reversed semicolon in protocol (now blocks instead of stripping)",
    },
    {
      url: "java\u2E1Dscript:alert(1)",
      expected: "about:blank",
      description: "Right low paraphrase bracket in protocol (now blocks instead of stripping)",
    },
    {
      url: "https\u2E1C://example.com",
      expected: "about:blank",
      description: "Left low paraphrase bracket in protocol (now blocks instead of stripping)",
    },
    {
      url: "/\u2E3E\u2E3E/etc/passwd",
      expected: "about:blank",
    ...
    },
    {
      url: "java\u070Fscript:alert(1)",
      expected: "about:blank",
      description: "Syriac abbreviation mark in protocol (now blocks instead of stripping)",
    },
    {
      url: "java\u2E40script:alert(1)",
      expected: "about:blank",
      description: "Double hyphen in protocol (now blocks instead of stripping)",
    },
    {
      url: "java\u2E01script:alert(1)",
      expected: "about:blank",
      description: "Right angle dotted substitution marker in protocol (still blocks)",
    },
    {
      url: "java\u2E04script:alert(1)",
      expected: "about:blank",
      description: "Left dotted substitution bracket in protocol (still blocks)",
    },
    {
      url: "java\u2E05script:alert(1)",
      expected: "about:blank",
      description: "Right dotted substitution bracket in protocol (still blocks)",
    },
    {
      url: "java\u2E07script:alert(1)",
      expected: "about:blank",
      description: "Raised dotted interpolation marker in protocol (still blocks)",
    },
    {
      url: "java\u2E08script:alert(1)",
      expected: "about:blank",
      description: "Dotted transposition marker in protocol (still blocks)",
    },
    {
      url: "java\u2E13script:alert(1)",
      expected: "about:blank",
      description: "Dotted obelos in protocol (still blocks)",
    },
    {
      url: "java\u2E16script:alert(1)",
      expected: "about:blank",
      description: "Dotted right-pointing angle in protocol (still blocks)",
    },
    {
      url: "java\u2E1Escript:alert(1)",
      expected: "about:blank",
      description: "Tilde with dot above in protocol (still blocks)",
    },
    {
      url: "java\u2E1Fscript:alert(1)",
      expected: "about:blank",
      description: "Tilde with dot below in protocol (still blocks)",
    },
    {
      url: "java\u2E17script:alert(1)",
      expected: "about:blank",
      description: "Oblique slant in protocol (now blocks instead of stripping)",
    },
    {
      url: "java\u2E09script:alert(1)",
      expected: "about:blank",
      description: "Left transcription bracket in protocol (still blocks)",
    },
    {
      url: "java\u2E0Ascript:alert(1)",
      expected: "about:blank",
      description: "Right transcription bracket in protocol (still blocks)",
    },
    {
      url: "java\u2E0Cscript:alert(1)",
      expected: "about:blank",
      description: "Raised wedge in protocol (still blocks)",
    },
    {
      url: "java\u2E0Dscript:alert(1)",
      expected: "about:blank",
      description: "Low wedge in protocol (still blocks)",
    },
    {
      url: "java\u2E12script:alert(1)",
      expected: "about:blank",
      description: "Dotted reversed comma in protocol (still blocks)",
    },
    {
      url: "java\u2E18script:alert(1)",
      expected: "about:blank",
      description: "Inverted interrogation mark in protocol (still blocks)",
    },
    {
      url: "java\u2E19script:alert(1)",
      expected: "about:blank",
      description: "Palm branch in protocol (still blocks)",
    },
    {
      url: null as unknown as string,
      expected: "",

...
const testCases = {
  ...
  sanitizeUrl: [
    ...
    },
    {
      url: "/\u2CFC\u2CFC/etc/passwd",
      expected: "about:blank",
      description: "Coptic capital letter old coptic ha bypass in relative path",
    },
    {
      url: "/\u2CFD\u2CFD/etc/passwd",
      expected: "about:blank",
      description: "Coptic small letter old coptic ha bypass in relative path",
    },
    {
      url: "/\u2CFE\u2CFE/etc/passwd",
      expected: "about:blank",
    ...
    },
    {
      url: "/\u2CFF\u2CFF/etc/passwd",
      expected: "about:blank",
      description: "Coptic morphological terminator bypass in relative path",
    },
    {
      url: "/\u1363\u1363/etc/passwd",
      expected: "about:blank",
    ...
    },
    {
      url: "/\u1364\u1364/etc/passwd",
      expected: "about:blank",
      description: "Ethiopic semicolon (alt) bypass in relative path",
    },
    {
      url: "/\u1367\u1367/etc/passwd",
      expected: "about:blank",
    ...
    },
    {
      url: "/\u1368\u1368/etc/passwd",
      expected: "about:blank",
      description: "Ethiopic full stop (alt) bypass in relative path",
    },
    {
      url: "/\u05C0\u05C0/etc/passwd",
      expected: "about:blank",
    ...
    },
    {
      url: "/\u070A\u070A/etc/passwd",
      expected: "about:blank",
      description: "Syriac abbreviation mark (dot-like) bypass in relative path",
    },
    {
      url: "/\u070B\u070B/etc/passwd",
      expected: "about:blank",
    ...
    },
    {
      url: "/\u070D\u070D/etc/passwd",
      expected: "about:blank",
      description: "Syriac harklean metobelos bypass in relative path",
    },
    {
      url: "/\u070E\u070E/etc/passwd",
      expected: "about:blank",
      description: "Syriac harklean astericos bypass in relative path",
    },
    {
      url: "/%80/attacker.com",
      expected: "about:blank",

...
const testCases = {
  ...
  sanitizeUrl: [
    ...
    },
    {
      url: "/\u2CFB\u2CFB/etc/passwd",
      expected: "about:blank",
      description: "Coptic full stop bypass in relative path (alt)",
    },
    {
      url: "/\u2CFC\u2CFC/etc/passwd",
      expected: "about:blank",
      description: "Coptic direct question mark bypass in relative path",
    },
    {
      url: "/\u2CFD\u2CFD/etc/passwd",
      expected: "about:blank",
    ...
    },
    {
      url: "/\u1364\u1364/etc/passwd",
      expected: "about:blank",
      description: "Ethiopic full stop bypass in relative path (alt)",
    },
    {
      url: "/\u1367\u1367/etc/passwd",
      expected: "about:blank",

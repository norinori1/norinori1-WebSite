...
**Vulnerability:** Open redirect and protocol-relative URL bypass via obscure ancient script word separators and punctuation.
**Learning:** Obscure Unicode characters such as word dividers and separators from Carian (U+10290, U+10291), Anatolian Hieroglyphs (U+145B1), Old Persian (U+103D0), Ugaritic (U+1039F), Phoenician (U+1091F), Lycian (U+1029F), Lydian (U+1093F), Meroitic (U+109BE, U+109BF), Old South Arabian (U+10A7F), Manichaean (U+10AF6), Avestan (U+10B39-U+10B3F), Kharoshthi (U+10A50-U+10A58), Old Hungarian (U+10CF9-U+10CFF), and Cuneiform (U+12470-U+12473) can be interpreted as path delimiters or separators by various components.
**Prevention:** Continuously harden relative path blocklists to include script-specific word dividers and punctuation marks across the entire Unicode space (especially non-BMP planes) that could be interpreted as dots or slashes at the start of a path.
